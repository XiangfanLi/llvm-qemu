...
#define CF_HASH_MASK   \
    ...
    LLVMValueRef func_ptr; /* pointer to the LLVM IR code */
    uint64_t (*p) (void); /* pointer to the machine code generated by LLVM IR*/
...
#define TB_JMP_RESET_OFFSET_INVALID 0xffff /* indicates no jump generated */
    ...
    char file_name[50];
//    char tcg_file_name[50];
    unsigned long long exec_cnt;
    TranslationBlock* llvm_jmp_dest[2];
