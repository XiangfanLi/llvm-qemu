...
static bool last_tb_exec_safe_return = true;

static LLVMGenericValueRef Args[1];
...
static inline llvm_tb_add_jump(TranslationBlock *tb, int n,
        TranslationBlock *tb_next)
{
//    int debug = 0;
//    printf("debug = %d\n", debug++);
