...
#Flags for LLVM-C
LLVM_CFLAGS_COMPILE = -I/usr/lib/llvm-9/include -D_GNU_SOURCE -D__STDC_CONSTANT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_LIMIT_MACROS
LLVM_CFLAGS_LINK = -L/usr/lib/llvm-9/lib -lLLVM-9 -lpthread
...
%.o: %.c
	$(call quiet-command,$(CC) -Wall $(QEMU_LOCAL_INCLUDES) $(QEMU_INCLUDES) \
	       $(QEMU_CFLAGS) $(LLVM_CFLAGS_COMPILE) $(QEMU_DGFLAGS) $(CFLAGS) $($@-cflags) \
	       -c -o $@ $<,"CC","$(TARGET_DIR)$@")
%.o: %.rc
...
LINK = $(call quiet-command, $(LINKPROG) $(call process-archive-undefs, $1) \
       $(version-obj-y) $(call extract-libs,$1) $(LIBS) \
       $(LLVM_CFLAGS_LINK) $(CFLAGS) $(QEMU_LDFLAGS) -o $@ \
       ,"LINK","$(TARGET_DIR)$@")
